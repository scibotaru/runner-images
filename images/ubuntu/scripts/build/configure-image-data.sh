...
github_url="https://github.com/scibotaru/runner-images/blob"
...
releaseUrl="https://github.com/scibotaru/runner-images/releases/tag/ubuntu${version_major}%2F${image_version_major}.${image_version_minor}"
