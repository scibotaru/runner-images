function Get-JavaVersions {
    ...
    return $javaVersions | Sort-Object $sortRules | ForEach-Object {
        ...
        # The path contains '-' sign in the version number instead of '+' due to the following issue, need to substitute it back https://github.com/scibotaru/runner-images/issues/3014
